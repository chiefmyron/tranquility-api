...
// Application classes
use Tranquillity\Data\Entities\Reference\CountryReferenceDataEntity;
use Tranquillity\Seeds\Fixtures\AbstractFixture;
use Tranquillity\Utility\ArrayHelper;

class CountryReferenceDataFixture extends AbstractFixture {
    ...
    public function __construct(array $options = []) {
        ...
        $this->referenceDataFilename = ArrayHelper::get($options, 'referenceDataFilename', 'ref_countries.csv');
    }
    ...
    public function load(ObjectManager $manager) {
        ...
        if (($handle = fopen($path, "r")) !== FALSE) {
            while (($data = fgetcsv($handle, 1000, ",")) !== FALSE) {
                ...
                $entity = new CountryReferenceDataEntity($row);
