...
use Tranquillity\System\Enums\MessageCodeEnum;
use Tranquillity\System\Exceptions\InvalidQueryParameterException;
...
class ResourceDocument extends AbstractDocument {
     ...
     *
     * @param \Tranquillity\Data\AbstractEntity          $entity   The data entity to build a meta object for
     ...
     *
     * @param \Tranquillity\Data\AbstractEntity          $entity   The data entity to build a links object for
     * @param \Psr\Http\Message\ServerRequestInterface  $request  PSR7 request
     * @return array
     */
     ...
     *
     * @param \Tranquillity\Data\AbstractEntity          $entity   The data entity to build an included object for
     * @param \Psr\Http\Message\ServerRequestInterface  $request  PSR7 request
     * @return array
     */
     ...
     * @param \Tranquillity\Data\AbstractEntity          $entity      The included data entity
     * @param \Psr\Http\Message\ServerRequestInterface  $request     PSR7 request
     * @return void
     */
