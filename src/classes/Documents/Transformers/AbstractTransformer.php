...
abstract class TransformerAbstract {
     ...
     * @var array
     */
    protected $availableIncludedResources = [];

    /**
     * Resources that are automatically included, without needing to be requested
     *
     * @var array
     */
    protected $defaultIncludedResources = [];

    /**
     * Get the collection of resources types that can be included
     *
     * @return array
     */
    public function getAvailableIncludedResources() {
        return $this->availableIncludedResources;
    }

    /**
     * Get the collection of resource types that are automatically included
     *
     * @return array
     */
    public function getDefaultIncludedResources() {
        return $this->defaultIncludedResources;
    }
