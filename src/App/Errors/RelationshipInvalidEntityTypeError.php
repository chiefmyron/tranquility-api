...
class RelationshipInvalidEntityTypeError extends AbstractError {
    ...
    public function __construct(int $errorCode, string $description = null, string $id = null) {
        ...
        $this->title = "Incorrect entity type for relationship";
        $this->codeHttpStatus = HttpStatusCodes::Conflict;
        return $this;
    }
}