...
use Tranquillity\Data\Entities\System\AuditTransactionEntity as Transaction;
...
abstract class AbstractBusinessService extends AbstractService {
     ...
     *
     * @param int $userId
     * @return Tranquillity\Data\Entities\BusinessObjects\UserBusinessObject
     */
     ...
     *
     * @param int $clientId
     * @return Tranquillity\Data\Entities\SystemObjects\OAuthClientSystemObject
     */
