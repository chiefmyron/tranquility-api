...
use Tranquillity\System\Enums\FilterOperatorEnum;
use Tranquillity\System\Enums\HttpStatusCodeEnum as HttpStatus;

// Tranquillity error messaging
use Tranquillity\App\Errors\Helpers\ErrorCollection;
use Tranquillity\Documents\AbstractDocument;

class AbstractController {
    /**
     * Entity service
     * 
     * @var \Tranquillity\Services\AbstractService
     */
    protected $service;
     ...
     * Constructor
     *
     * @param \Tranquillity\Services\AbstractService  $service  Service used to interact with the primary entity data
     * @return void
     */
